      ...
      {open &&
        createPortal(
          <div className="hotkeys-overlay" onClick={() => setOpen(false)}>
            <div
              className="hotkeys-popover"
              onClick={(e) => e.stopPropagation()}
            >
              <button className="hotkeys-close" onClick={() => setOpen(false)}>
                &times;
              </button>
              ...
              <div className="hotkeys-tabs">
                <button
                  className={`hotkeys-tab${tab === "shortcuts" ? " hotkeys-tab--active" : ""}`}
                  onClick={() => setTab("shortcuts")}
                >
                  Shortcuts & Tips
                </button>
                <button
                  className={`hotkeys-tab${tab === "guide" ? " hotkeys-tab--active" : ""}`}
                ...
                <div className="hotkeys-guide">
                  ...
                  <div className="hotkeys-guide-section">
                    ...
                    <p>
                      ...
                      <strong>
                        top gainers, losers, trending stocks, futures, and
                        crypto
                      </strong>{" "}
                      all in one place. The <strong>Fear & Greed gauge</strong>{" "}
                      shows overall market sentiment. You can{" "}
                      <strong>drag and rearrange any section</strong> on the
                      Home page to customize the layout to your preference — put
                      the sections you care about most at the top.
                    </p>
                  </div>
                  ...
                  <div className="hotkeys-guide-section">
                    ...
                    <p>
                      Click any stock to open the{" "}
                      <strong>expanded chart</strong>. From there you can:
                    </p>
                    <ul>
                      <li>
                        Switch between <strong>14 timeframes</strong> (1m, 5m,
                        15m, 1h, 4h, Daily, Weekly, etc.)
                      </li>
                      <li>
                        Change <strong>chart type</strong>: Candle, Line, Area,
                        Bar, or Heikin-Ashi
                      </li>
                      <li>
                        Add <strong>indicators</strong>: EMA 9/21, VWAP, RSI,
                        and MACD
                      </li>
                      <li>
                        Use <strong>drawing tools</strong>: horizontal lines,
                        trendlines, rays, and Fibonacci retracements
                      </li>
                      <li>
                        <strong>Compare stocks</strong>: click the compare icon
                        to overlay another symbol
                      </li>
                      <li>
                        Drag the <strong>right price panel</strong> to zoom
                        candles in/out
                      </li>
                      <li>
                        View <strong>key stats</strong> (P/E, market cap, beta,
                        dividend, etc.) in the sidebar
                      </li>
                      <li>
                        Read <strong>related news</strong> articles for the
                        stock
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="hotkeys-guide-section">
                    ...
                    <ul>
                      <li>
                        <strong>Top Runners / Losers</strong> — Today's biggest
                        movers by % change
                      </li>
                      <li>
                        <strong>Pre/After</strong> — Extended hours movers
                        (pre-market & after-hours)
                      </li>
                      <li>
                        <strong>Trending</strong> — Most actively traded stocks
                      </li>
                      <li>
                        <strong>Favorites</strong> — Your saved stocks (drag to
                        reorder)
                      </li>
                      <li>
                        <strong>Futures</strong> — S&P 500, Nasdaq, Dow, Russell
                        & more with sparklines
                      </li>
                      <li>
                        <strong>Crypto</strong> — Top cryptocurrency prices and
                        24h changes
                      </li>
                      <li>
                        <strong>Screener</strong> — Filter stocks by market cap,
                        price, volume, sector
                      </li>
                      <li>
                        <strong>Heatmap</strong> — Visual sector performance map
                      </li>
                      <li>
                        <strong>News</strong> — Live market news from CNBC,
                        Bloomberg, MarketWatch
                      </li>
                      <li>
                        <strong>Earnings</strong> — Calendar of upcoming and
                        recent earnings calls
                      </li>
                      <li>
                        <strong>Economy</strong> — Economic calendar (CPI, jobs,
                        GDP, Fed events)
                      </li>
                      <li>
                        <strong>Smart Money</strong> — WSB sentiment, insider
                        trading, options flow, congress trades, dark pool data &
                        more
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="hotkeys-guide-section">
                    ...
                    <p>
                      The scrolling banner at the top shows an{" "}
                      <strong>AI-generated market summary</strong>. Click it to
                      expand the full digest with bullet points covering today's
                      key market developments, index moves, and earnings
                      highlights.
                    </p>
                  </div>
                  ...
                  <div className="hotkeys-guide-section">
                    <h4>Price Alerts</h4>
                    <p>
                      Click the <strong>bell icon</strong> to set price alerts.
                      Choose a target price and whether to trigger when the
                      stock goes above or below it. You'll hear a notification
                      sound when an alert fires. Manage all alerts from the bell
                      panel.
                    </p>
                  </div>
                  ...
                  <div className="hotkeys-guide-section">
                    ...
                    <p>
                      Click the <strong>camera icon</strong> on any chart to
                      enter snip mode. Click and drag to select an area — it
                      will be copied to your clipboard and downloadable as a
                      PNG.
                    </p>
                  </div>
                  ...
                  <div className="hotkeys-guide-section">
                    ...
                    <p>
                      <strong>Ctrl + Click</strong> (or Cmd + Click on Mac) on
                      multiple stock cards to open a side-by-side chart grid for
                      comparing performance across symbols.
                    </p>
                  </div>
                  ...
                  <div className="hotkeys-guide-section">
                    ...
                    <p>
                      <strong>Sign in</strong> to sync your favorites and alerts
                      across devices. Click the star on any stock to save it.
                      Drag cards in the Favorites tab to reorder them. Your
                      theme and tab preferences are saved locally.
                    </p>
                  </div>
                  ...
                  <div className="hotkeys-guide-section">
                    <h4>Data Sources</h4>
                    <p>
                      Market data is sourced from Yahoo Finance, TradingView,
                      Finnhub, Quiver Quantitative, ApeWisdom, Coinbase, and
                      FINRA. Quotes may be delayed up to 15 minutes. Extended
                      hours data reflects pre-market (4:00–9:30 AM ET) and
                      after-hours (4:00–8:00 PM ET) activity. This is not
                      financial advice.
                    </p>
                  </div>
                </div>
...
export default function Header({
  ...
  useEffect(() => {
    const handleClickOutside = (e) => {
      ...
      const inMobile =
        mobileWrapperRef.current && mobileWrapperRef.current.contains(e.target);
    ...
    <>
      <header className="header">
        ...
        <div className="header-utility">
          ...
          <div
            className="search-wrapper header-utility-search"
            ...
            >
              {theme === "dark" ? (
                ...
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M14 10.5A6.5 6.5 0 015.5 2 6.5 6.5 0 1014 10.5z" />
                </svg>
              )}
            </button>
          </MagneticElement>
        ...
        <div className="header-tabs-container">
          ...
          {canScrollRight && (
            <span className="header-tabs-scroll-hint" aria-hidden="true">
              ›
            </span>
          )}
        </div>
