      ...
      {Array.from({ length: 6 }, (_, i) => (
        <div key={i} className="skeleton-card">
          <div className="skeleton-card-header">
            ...
            <div className="skeleton-line" style={{ width: 50, height: 20, borderRadius: 10, marginLeft: 'auto' }} />
          </div>
          <div className="skeleton-card-chart">
            <div className="skeleton-line" style={{ width: '100%', height: '100%', borderRadius: 6 }} />
          </div>
