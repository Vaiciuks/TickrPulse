    ...
    `;
      ...
      const frame = () => {
        ...
        if (foundEl !== currentOverEl) {
          if (currentOverEl)
            currentOverEl.classList.remove("fav-card--dragover");
      ...
      {favorites.length === 0 ? (
        <div className="fav-empty">
          ...
          <p className="fav-empty-text">
            Star stocks from any tab to build your favorites
          </p>
          <p className="fav-empty-sub">
            Click the star icon on any stock card to add it here
          </p>
        </div>
      ) : (
        <div
