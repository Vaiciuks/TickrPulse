    ...
    return [...list].sort((a, b) => {
      ...
      switch (sortCol) {
        ...
        case "shortRatio":
          ...
          break;
        case "sharesShort":
          aVal = a.sharesShort || 0;
          bVal = b.sharesShort || 0;
          break;
        case "shortPercentOfFloat":
        default:
          aVal = a.shortPercentOfFloat || 0;
          bVal = b.shortPercentOfFloat || 0;
          break;
      }
        ...
        <thead>
          <tr>
            ...
            <th
              ...
              className={sortCol === "changePercent" ? "sorted" : ""}
            >
              Change{sortIcon("changePercent")}
            </th>
            <th
              onClick={() => handleSort("shortPercentOfFloat")}
              className={sortCol === "shortPercentOfFloat" ? "sorted" : ""}
            >
              Short % Float{sortIcon("shortPercentOfFloat")}
            </th>
            <th
              onClick={() => handleSort("shortRatio")}
              className={sortCol === "shortRatio" ? "sorted" : ""}
            >
        ...
        <tbody>
          {stocks.map((s) => {
            ...
            const fillPct = Math.min(
              (((s.shortPercentOfFloat || 0) * 100) / 40) * 100,
              100,
            );
            return (
              <tr
